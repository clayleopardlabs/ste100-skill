...
| 5 | 4 | "Hold the wrench with the left hand while **holding** the valve." — **-ing form "holding"** | Rule 3.5 (-ing form) + 3.7 (while-join) | "Holding" is not one of the 9 approved -ing forms. Rewrite with an approved form: "Hold the wrench with the left hand. Hold the valve." or "Hold the wrench with the left hand and hold the valve with the right hand." (two separate actions). |
